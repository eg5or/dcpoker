          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <StatsCard
                ...
                icon={
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zM7 9a1 1 0 100-2 1 1 0 000 2zm7-1a1 1 0 11-2 0 1 1 0 012 0zm-1.536 5.535a1 1 0 001.414-1.414 3 3 0 00-4.242 0 1 1 0 001.414 1.414 1 1 0 011.414 0z" clipRule="evenodd" />
                  </svg>
                }
              />
              <StatsCard
                title="Всего получено эмодзи"
                value={stats.emojisStats.received.reduce((acc, cur) => acc + cur.count, 0).toString()}
                icon={
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" viewBox="0 0 20 20" fill="currentColor">
