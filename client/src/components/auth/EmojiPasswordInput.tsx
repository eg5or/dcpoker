...
export function EmojiPasswordInput({
  ...
  return (
    <div className="emoji-input-container">
      ...
      <div className="relative">
        ...
        >
          ...
          <div className="emoji-controls-container flex items-center ml-3 min-w-[72px] justify-end">
            <div
              className={`emoji-controls flex items-center space-x-2 transition-opacity duration-200 ${selectedEmojis.length > 0 ? 'opacity-100' : 'opacity-0'}`}
            >
              <button
                type="button"
              ...
              >
                ...
                >
                  <path
                    fillRule="evenodd"
                    d="M10 18a8 8 0 100-16 8 8 0 000 16zM6.5 9.5a.5.5 0 011 0V11h1.5a.5.5 0 010 1H7.5v1.5a.5.5 0 01-1 0V12H5a.5.5 0 010-1h1.5V9.5z"
                    clipRule="evenodd"
      ...
      <input type="hidden" id={id} value={selectedEmojis.join('')} required={required} />
    </div>
  );
}
